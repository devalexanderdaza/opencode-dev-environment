...
- [YOUR_VALUE_HERE: Major decision 3]

**Critical Dependencies**:
- [YOUR_VALUE_HERE: Blocking dependency 1]
- [YOUR_VALUE_HERE: Blocking dependency 2]
...
- [YOUR_VALUE_HERE: Specific deliverable or feature component 4]
- [YOUR_VALUE_HERE: Specific deliverable or feature component 5]
...
| [YOUR_VALUE_HERE: path/to/another.js] | [Modify/Create/Delete] | [Brief description of change] |
...
### User Story 1 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P0)
...
3. **Given** [YOUR_VALUE_HERE: initial state], **When** [YOUR_VALUE_HERE: user action], **Then** [YOUR_VALUE_HERE: expected outcome]

[example: **Given** user is logged in, **When** they navigate to metrics page, **Then** they see usage data for the last 30 days]

---

### User Story 2 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P0)
...
### User Story 3 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P1)
...
### User Story 4 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P1)
...
### User Story 5 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P2)
...
### User Story 6 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P2)
...
### User Story 7 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P2)
...
### User Story 8 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P2)
...
[OPTIONAL: Add User Stories 9-15 if needed for enterprise-scale features - Level 3+ supports up to 15 user stories]
...
- **REQ-FUNC-005:** System MUST [YOUR_VALUE_HERE: specific capability]
- **REQ-FUNC-006:** System MUST [YOUR_VALUE_HERE: specific capability]
- **REQ-DATA-002:** System MUST [YOUR_VALUE_HERE: data requirement]
- **REQ-INTG-001:** System MUST [YOUR_VALUE_HERE: integration requirement]
- **REQ-INTG-002:** System MUST [YOUR_VALUE_HERE: integration requirement]

**Requirements Needing Clarification**:
- **REQ-FUNC-007:** System MUST authenticate users via [NEEDS CLARIFICATION: auth method not specified - email/password, SSO, OAuth, magic link?]
- **REQ-DATA-003:** System MUST retain user data for [NEEDS CLARIFICATION: retention period not specified - 30 days, 1 year, indefinite?]
...
|------------|---------------------|-------|
| Story 1 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-001, REQ-FUNC-003, REQ-DATA-001 | [OPTIONAL: additional notes] |
| Story 2 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-002, REQ-FUNC-004, REQ-DATA-002 | [OPTIONAL: additional notes] |
| Story 3 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-005, REQ-INTG-001 | [OPTIONAL: additional notes] |
| Story 4 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-006, REQ-INTG-002 | [OPTIONAL: additional notes] |
| Story 5 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-007, REQ-DATA-003 | [OPTIONAL: additional notes] |
| Story 6 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-008 | [OPTIONAL: additional notes] |
...
- What happens when [YOUR_VALUE_HERE: boundary condition]?
...
- How does system handle [YOUR_VALUE_HERE: error scenario]?
...
- How does system handle [YOUR_VALUE_HERE: state transition]?
...
| [YOUR_VALUE_HERE: Dependency] | External/Internal | [YOUR_VALUE_HERE: Team] | [FORMAT: Green/Yellow/Red] | [YOUR_VALUE_HERE: Impact description] |
...
| R-003 | [YOUR_VALUE_HERE: Risk description] | High/Med/Low | High/Med/Low | [YOUR_VALUE_HERE: Mitigation plan] | [YOUR_VALUE_HERE: Name] |
...
- ✅ Feature requires clear requirements and user stories (Level 3+)
- ✅ Enterprise-scale features requiring 8-15 user stories
- ✅ Multiple stakeholders need alignment on scope and acceptance criteria
- ✅ Executive summary needed for high-level overview
- ✅ Complexity assessment required for planning
- ✅ Traceability between user stories and requirements is critical
- ✅ Multi-agent or multi-workstream coordination needed

For Level 3+ features:
- **Level 3+**: Extended SpecKit with all advanced templates
- Complexity score: 80-100 (Enterprise-scale, multi-agent)
- 8-15 user stories with independent testing
...
<!--
  SPEC TEMPLATE - LEVEL 3+ (EXTENDED - ENTERPRISE)
  - Defines WHAT needs to be built and WHY
  - 8-15 user stories prioritized and independently testable
  - Requirements traceable to stories
  - WITH Complexity Assessment
  - WITH Executive Summary
  - WITH Research Methodology (if applicable)
