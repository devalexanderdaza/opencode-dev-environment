...
- Multi-workstream coordination required
- Team needs clear task assignments and dependencies
- Tasks span multiple phases or team members
- Requirement traceability critical for compliance/audit

**Level 3+ requirements:**
- tasks.md is REQUIRED for Level 3+
- Extended task breakdown with workstreams and coordination
- 100-200 tasks typical for Level 3+ complexity
- Use Tier 2 (Standard) or Tier 3 (Full) task format
- Link tasks to requirements from spec.md
- Workstream isolation and sync points documented
...
<!--
  TASKS TEMPLATE - LEVEL 3+ (EXTENDED - ENTERPRISE)
  - 100-200 tasks organized by user story and workstream
  - WITH 3-Tier task format
  - WITH requirement linking
  - WITH acceptance criteria
  - WITH verification steps
  - WITH workstream coordination
  - WITH AI execution protocol integration
-->
