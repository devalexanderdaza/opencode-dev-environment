...
[OPTIONAL: Add User Stories 7-8 if needed for complex features]
...
- ✅ Complex features requiring 4-8 user stories
...
- **Level 3**: Full SpecKit with spec.md + plan.md + tasks.md + checklist.md + decision-record.md
- Complexity score: 56-79 (Complex changes, ≥500 LOC)
- 4-8 user stories with independent testing
...
<!--
  SPEC TEMPLATE - LEVEL 3 (FULL - COMPLEX)
  - Defines WHAT needs to be built and WHY
  - 4-8 user stories prioritized and independently testable
