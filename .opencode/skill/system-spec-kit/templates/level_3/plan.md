...
```
Phase Dependencies (Critical Path Highlighted):
...
|------|----------|--------|
| Main: 0→1→2→3→4→5 | [YOUR_VALUE_HERE] | CRITICAL |
...
| M4: Integration | PH-3 | E2E tests passing | [TBD] |
| M5: Release | PH-5 | Production ready | [TBD] |
...
| Phase 5: Deployment | [YOUR_VALUE_HERE] | [H/M/L] | [Risk factors] |
...
- Full plan with all sections for complex features
- 5-8 implementation phases
- WITH AI Execution Framework
- WITH ASCII dependency graph
...
<!--
  PLAN TEMPLATE - LEVEL 3 (FULL - COMPLEX)
