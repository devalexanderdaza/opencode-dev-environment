...
**Use plan.md when:**
- Creating Level 2 spec folders (moderate complexity features)
- Need to define technical approach and architecture before implementation
- 3-5 phases of work requiring coordination
...
**Level requirements:**
- plan.md is REQUIRED for Level 2
- Level 2: Standard plan with dependency tracking and effort estimation
- For complex features, use Level 3 template
...
- Create `checklist.md` for validation procedures
