...
| [YOUR_VALUE_HERE: path/to/other.js] | [Modify/Create/Delete] | [Brief description of change] |
...
3. **Given** [initial state], **When** [action], **Then** [outcome]
...
### User Story 4 - [YOUR_VALUE_HERE: Brief descriptive title] (Priority: P0/P1/P2)
...
- **REQ-FUNC-005:** System MUST [YOUR_VALUE_HERE: additional capability]
- **REQ-INTG-001:** System MUST [YOUR_VALUE_HERE: integration requirement]

**Requirements Needing Clarification**:
- **REQ-FUNC-006:** System MUST authenticate users via [NEEDS CLARIFICATION: auth method not specified - email/password, SSO, OAuth, magic link?]
...
- **REQ-FUNC-007:** System MUST [NEEDS CLARIFICATION: unclear requirement - provide specific details]
...
| Story 4 - [YOUR_VALUE_HERE: Title] | REQ-FUNC-006, REQ-INTG-001 | [OPTIONAL: additional notes] |
...
| [YOUR_VALUE_HERE: Another dependency] | External/Internal | [YOUR_VALUE_HERE: Team] | [FORMAT: Green/Yellow/Red] | [YOUR_VALUE_HERE: Impact description] |
...
- ✅ Feature requires clear requirements and user stories (Level 2)
- ✅ Multiple stakeholders need alignment on scope and acceptance criteria
- ✅ Moderate complexity requires formal requirements documentation
- ✅ Traceability between user stories and requirements is important

For more complex features:
- **Level 3**: Full SpecKit with additional templates (ADRs, executive summary, etc.)
...
<!--
  SPEC TEMPLATE - REQUIREMENTS & USER STORIES (LEVEL 2)
  - Defines WHAT needs to be built and WHY
  - User stories prioritized and independently testable (2-4 stories)
  - Requirements traceable to stories
  - Uses REQ-XXX identifiers for change tracking
  - Includes Complexity Assessment for tracking
