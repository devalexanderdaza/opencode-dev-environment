#!/usr/bin/env bash
# ───────────────────────────────────────────────────────────────
# SPEC-KIT: MEMORY SYSTEM SETUP
# ───────────────────────────────────────────────────────────────
#
# Usage: ./setup.sh [--force]
# Options: --force  Reinstall dependencies even if node_modules exists
...
if [[ "$VERIFY_OK" == true ]]; then
  ...
  echo ""
  echo "Documentation:"
  echo "  See .opencode/skill/system-spec-kit/ for skill documentation"
else
